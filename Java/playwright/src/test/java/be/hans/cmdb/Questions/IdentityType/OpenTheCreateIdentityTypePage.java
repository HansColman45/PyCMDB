...
/**
 * Question to open the Create Identity Type page from the Identity Type Overview page.
 */
public class OpenTheCreateIdentityTypePage extends Question<CreateTypePage> {

    /**
     * Perform the action of opening the Create Identity Type page.
